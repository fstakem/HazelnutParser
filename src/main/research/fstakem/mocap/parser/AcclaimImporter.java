...
public class AcclaimImporter 
{
	...
	public static AsfData parseAsfData(List<String> lines) throws ParseException
	{
		...
		HashMap<String, List<String>> sections = AsfParser.seperateSections(lines);
		...
		asf_data.documentation = AsfParser.parseDocumentation(sections);
	...
	public static AmcData parseAmcData(List<String> lines) throws ParseException
	{
		...
		List<List<String>> frames = AmcParser.seperateFrames(lines);
